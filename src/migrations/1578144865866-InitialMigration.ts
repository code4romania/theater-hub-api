...
export class InitialMigration1578144865866 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "ProjectImage" ("DateCreated" TIMESTAMP NOT NULL DEFAULT now(), "DateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "Version" integer NOT NULL, "ID" uuid NOT NULL DEFAULT uuid_generate_v4(), "Key" character varying NOT NULL, "Location" character varying NOT NULL, "ThumbnailLocation" character varying NOT NULL, "Size" numeric NOT NULL, "ProjectID" uuid, CONSTRAINT "REL_0314b4973ec37191127e34fc51" UNIQUE ("ProjectID"), CONSTRAINT "PK_03444fde5df9645896a00e848a6" PRIMARY KEY ("ID"))`);

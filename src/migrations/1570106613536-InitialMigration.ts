...
export class InitialMigration1570106613536 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "ProjectNeedTag" ("DateCreated" TIMESTAMP NOT NULL DEFAULT now(), "DateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "Version" integer NOT NULL, "ProjectNeedID" uuid NOT NULL, "TagID" character varying NOT NULL, CONSTRAINT "PK_eeceb7a682450fa3207d7257be4" PRIMARY KEY ("ProjectNeedID", "TagID"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ProjectNeedTag" ADD CONSTRAINT "FK_6f6c96d3f557bf638e9b6feb569" FOREIGN KEY ("TagID") REFERENCES "Tag"("ID")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "ProjectNeedTag" DROP CONSTRAINT "FK_6f6c96d3f557bf638e9b6feb569"`);

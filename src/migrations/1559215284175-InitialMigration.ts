...
export class InitialMigration1559215284175 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "UserImage" ("DateCreated" TIMESTAMP NOT NULL DEFAULT now(), "DateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "Version" integer NOT NULL, "ID" uuid NOT NULL DEFAULT uuid_generate_v4(), "Key" character varying NOT NULL, "Location" character varying NOT NULL, "Size" numeric NOT NULL, "IsProfileImage" boolean NOT NULL, "UserID" uuid, CONSTRAINT "PK_a7b8f73d33c3a99ca1b1145eeb6" PRIMARY KEY ("ID"))`);

...
export class InitialMigration1563878571697 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "ProjectImage" ("DateCreated" TIMESTAMP NOT NULL DEFAULT now(), "DateUpdated" TIMESTAMP NOT NULL DEFAULT now(), "Version" integer NOT NULL, "ID" uuid NOT NULL DEFAULT uuid_generate_v4(), "Key" character varying NOT NULL, "Location" character varying NOT NULL, "ThumbnailLocation" character varying NOT NULL, "Size" numeric NOT NULL, "ProjectID" uuid, CONSTRAINT "PK_03444fde5df9645896a00e848a6" PRIMARY KEY ("ID"))`);
        await queryRunner.query(`CREATE TABLE "ProjectNeed" ("ID" uuid NOT NULL DEFAULT uuid_generate_v4(), "Description" character varying(500) NOT NULL, "IsImportant" boolean NOT NULL, "ProjectID" uuid, CONSTRAINT "PK_8952f563a39e0dd9a759bac286c" PRIMARY KEY ("ID"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ProjectImage" ADD CONSTRAINT "FK_0314b4973ec37191127e34fc513" FOREIGN KEY ("ProjectID") REFERENCES "Project"("ID") ON DELETE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "ProjectImage" DROP CONSTRAINT "FK_0314b4973ec37191127e34fc513"`);
